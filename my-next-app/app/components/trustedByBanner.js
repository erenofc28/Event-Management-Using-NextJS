        ...
        >
          {[...Array(20)].map((_, i) => (
            <div key={i} className="flex items-center mx-10">
              <span className="font-medium text-[11px] tracking-[0.3em] text-black">TRUSTED BY</span>
              <VerifiedIcon />
            </div>
          ))}
        </motion.div>
