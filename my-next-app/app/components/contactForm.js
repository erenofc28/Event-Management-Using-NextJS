      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 md:space-y-12">
          ...
          <div className="lg:max-w-[50%] lg:pr-6">
            <button
              type="submit"
              className=" bg-[#541A2E] w-full text-white font-satoshi text-xl md:text-2xl font-light leading-[150%] py-3 md:py-4 px-6 rounded transition-all duration-300 hover:opacity-90 active:scale-[0.98]"
            >
              Submit
            </button>
          </div>
