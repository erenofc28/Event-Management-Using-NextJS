...
export default function Services() {
  return (
    <>
      <Hero
        content={"  Experience Our Services"}
          ...
          <div className="max-w-[1100px] mx-auto text-center">
            <h2
              className="font-playfair
                 text-4xl sm:text-4xl md:text-5xl lg:text-[72px]
                 font-normal leading-[130%] tracking-[0.02em]
                 text-[#2835AB]
                 mb-8 sm:mb-8"
            >
              Where Happiness Begins & <br className="hidden md:block" /> Love
              Is Celebrated
            </h2>

            <p
              className="font-satoshi
                 text-lg sm:text-lg lg:text-2xl
                 font-normal leading-[150%] tracking-[0.05em]
                 max-w-4xl mx-auto"
            >
              <span className="text-black">
                At Kalakar Events, we craft weddings filled with{" "}
              </span>
              <span className="text-[#2835AB] font-medium">
                love, joy, and unforgettable moments
              </span>
              <span className="text-black">
                . Every detail is thoughtfully designed to reflect your story
                and celebrate your happiness. Explore our services and book us
                immediately to begin a beautiful journey made just for you.
              </span>
            </p>
          </div>
        </section>
  ...
  "
                >
                  ...
                  <h3 className="font-satoshi text-3xl lg:text-[48px] font-light leading-[1.1] mb-6">
                    ...
                    <span className="text-black">That Last Forever</span>
                  </h3>

                  <p className="font-satoshi text-sm lg:text-base leading-[1.7] text-black/70 mb-8">
                    Our photography service is crafted to capture emotions as
                    they naturally unfold, preserving every smile, glance, and
                    heartfelt moment. With an eye for detail and storytelling,
                    we document your celebration in a way that feels authentic
                    and timeless.
                  </p>
  ...
  -12 lg:py-20 relative"
        ...
        "
                >
                  ...
                  <h3 className="font-satoshi text-3xl lg:text-[48px] font-light leading-[1.1] mb-6">
                    <span className="font-regale font-normal text-[#2835AB] block mb-1">
                      Management &
                    </span>
                    <span className="text-black">
                      Hospitality That Elevates Every Experience
                    </span>
                  </h3>

                  <p className="font-satoshi text-sm lg:text-base leading-[1.7] text-black/70 mb-8 max-w-[680px] mx-auto lg:mx-0">
                    Our management and hospitality team ensures seamless
                    coordination, thoughtful guest care, and smooth execution
                    throughout your celebration, allowing you to relax and enjoy
